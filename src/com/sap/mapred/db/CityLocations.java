 ...
 */
public class CityLocations implements DBWritable, Writable {
    public int locId;
    ...
    public void write(PreparedStatement stmt) throws SQLException {
        ...
        stmt.setString(3, this.region);
        stmt.setString(4, this.city);
        stmt.setString(5, this.postalCode);
        stmt.setInt(6, this.latitude);
        stmt.setInt(7, this.longitude);
        stmt.setInt(8, this.metroCode);
        stmt.setInt(9, this.areaCode);
    }
}
